...
public class TrafficController extends BaseController<Traffic> {
    ...
    @GetMapping("/get-traffic-by-id/{idTraffic}")
    public ResponseEntity<?> getAllTrafficById(@PathVariable(name="idTraffic") Integer idTraffic){
        return this.resSuccess(trafficService.getTrafficById(idTraffic));
    }
